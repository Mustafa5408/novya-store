...
========================================================= */
const PRODUCTS = [
 {id:'chopper',name:'Chopper',category:'Kitchen Appliances',price:2499,stock:20,image:'https://placehold.co/800x800/f1f5f9/111827?text=Chopper',description:'Convenient kitchen chopper for quick and easy food preparation.',features:['High-quality construction','Quick and easy to use','Compact kitchen design','Easy to clean','Suitable for everyday food preparation']},
 {id:'beater',name:'Beater',category:'Kitchen Appliances',price:1999,stock:15,image:'https://placehold.co/800x800/f1f5f9/111827?text=Beater',description:'Useful electric beater for mixing and preparing everyday recipes.',features:['Easy mixing performance','Comfortable to handle','Suitable for daily recipes','Compact and convenient','Durable everyday design']},
 {id:'induction-hot-plate',name:'Induction Hot Plate',category:'Kitchen Appliances',price:3499,stock:10,image:'https://placehold.co/800x800/f1f5f9/111827?text=Induction+Hot+Plate',description:'Compact induction hot plate suitable for everyday cooking.',features:['Compact space-saving design','Convenient for everyday cooking','Easy controls','Portable and practical','Durable construction']},
